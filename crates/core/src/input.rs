...
// pub fn ppp() -> &'static u8 {
//     &get_backend().mouse_state().pressed
// }
...
#[inline]
pub fn is_key_pressed(pkey: KeyCode) -> bool {
    todo!()
}

#[inline]
pub fn are_keys_pressed<const N: usize>(pkeys: &[KeyCode; N]) -> [bool; N] {
    todo!()
}
